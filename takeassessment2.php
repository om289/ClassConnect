    ...
    <div class="row">
        <div class="col-md-12">
            ...
            if (isset($_POST['done'])) {
                ...
                $tempq1 = mysqli_real_escape_string($conn, $_POST['Q1']);
                $tempq2 = mysqli_real_escape_string($conn, $_POST['Q2']);
                $tempq3 = mysqli_real_escape_string($conn, $_POST['Q3']);
                $tempq4 = mysqli_real_escape_string($conn, $_POST['Q4']);
                $tempq5 = mysqli_real_escape_string($conn, $_POST['Q5']);

                // Insert Assessment Answers
                $sql = "INSERT INTO `examans` (ExamID, RollNumber, Answer, MarksObtained)
                        VALUES ('$Ex_id','$sEno','$tempsname','$tempq1,$tempq2,$tempq3,$tempq4,$tempq5')";

                if (mysqli_query($conn, $sql)) {
                    // Insert Progress Tracking for Last 20 Days
                    $progressSql = "INSERT INTO `student_progress` (RollNumber, activity, activity_date)
                                    VALUES ('$userid', 'Assessment Completed: $Ex_id', CURDATE())";
                    ...
                    echo "<br><strong>Assessment Submission Failed.</strong> Error: " . mysqli_error($conn);
                }
