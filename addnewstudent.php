...
<div class="container">
    <div class="row">
        ...
        if (isset($_POST['addnews'])) {
            ...
            $tempeid = $_POST['email'];
            $temppass = $_POST['pass'];
            $stmt = $connect->prepare("INSERT INTO studenttable (RollNumber, FName, LName, FaName, DOB, Addrs, Gender, Course, PhNo, Email, Pass) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
            $stmt->bind_param("issssssssss", $temprollnumber, $tempfname, $templname, $tempfaname, $tempdob, $tempaddrs, $tempgender, $tempcourse, $tempphno, $tempeid, $temppass);
            ...
            if ($stmt->execute()) {
                ...
                echo "<br><strong>Admission Failure. Try Again</strong><br> Error Details: " . $stmt->error;
            }
            $stmt->close();
